...
/* Events in JS (JS Hodisalar) */

/*function meniBirMartaBos (){
    alert("Siz battoni bir marta bosdingiz")
}*/
/*function meniIkkiMartaBos (){
    alert("Siz battoni ikki marta bosing")
}*/
...
/*function inputdanChiqish(){
    console.log("Inputdan chqilidi")
}*/
/*function yozish(event){
    console.log(event.target.value)
}*/
/*document.querySelector(".matnTegi").addEventListener('copy',function (event){
    console.log("Diqqat! Diqqat! Sizdan " +event.target.value + "nomli xujjatlar kochirilyapti!");
})*/
function kirish(){
    console.log("Hududga kirildi!")
}
function chiqish(){
    console.log("Hududan chiqildi!")
}
